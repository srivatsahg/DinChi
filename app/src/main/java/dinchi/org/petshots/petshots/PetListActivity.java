...
import dinchi.org.petshots.database.PetDataBinder;
import dinchi.org.petshots.utils.ParcelablePetDetail;
import dinchi.org.petshots.utils.PetDetail;
import dinchi.org.petshots.utils.PetListLayoutUpdater;
        	...
        	listview.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					if(selPet != null){
						...
						info.setClass(PetListActivity.this, dinchi.org.petshots.petshots.PetInformationView.class);
