...
import dinchi.org.petshots.database.HelpTopicContent;
import dinchi.org.petshots.utils.Constants;
import dinchi.org.petshots.utils.HelpWindowLayoutUpdater;
...
public class HelpDescriptionActivity extends Activity {
    ...
    private final static String LOG_CLASS = "[HelpDescActiv]";
