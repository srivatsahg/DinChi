...
import dinchi.org.petshots.database.GenericDataBinder;
...
import dinchi.org.petshots.utils.VaccineEntryLayoutUpdater;
...
//        		makeToast("Please select a valid future date !!");
    ...
    private void showAlertDialog(String title, String message){
        ...
        final Dialog dialog = new Dialog(VaccineEntryActivity.this,R.style.CustomDialog);
