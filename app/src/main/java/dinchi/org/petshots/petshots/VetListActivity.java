...
import dinchi.org.petshots.database.DoctorDataBinder;
import dinchi.org.petshots.utils.DoctorDetails;
import dinchi.org.petshots.utils.DoctorListLayoutUpdater;
import dinchi.org.petshots.utils.ParcelableDocDetail;

public class VetListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fabaddvet);
		fab.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				Log.i(LOG_CLASS, "<< --- Creating Vet information --- >>");
				createVetDetail();
			}
		});
        ...
        listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if(docdetail != null){
					...
					info.setClass(VetListActivity.this, dinchi.org.petshots.petshots.VetInformationViewActivity.class);
