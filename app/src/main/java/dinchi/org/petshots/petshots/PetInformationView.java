...
import dinchi.org.petshots.utils.ParcelablePetDetail;
import dinchi.org.petshots.utils.PetDetail;
import dinchi.org.petshots.utils.PetInfoLayoutUpdater;
...
public class PetInformationView extends Activity {
    ...
    private void showAlertDialog(String title, String message){
        ...
        final Dialog dialog = new Dialog(PetInformationView.this,R.style.CustomDialog);
        ...
        ivDialogIcon.setImageDrawable(getApplicationContext().getResources().getDrawable(R.mipmap.ic_action_warning));
