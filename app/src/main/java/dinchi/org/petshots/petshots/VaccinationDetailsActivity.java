...
import dinchi.org.petshots.database.CentralDataSource;
import dinchi.org.petshots.database.VaccineDataBinder;
import dinchi.org.petshots.utils.Constants;
import dinchi.org.petshots.utils.DoctorDetails;
import dinchi.org.petshots.utils.LayoutUpdater;
import dinchi.org.petshots.utils.PetDetail;
import dinchi.org.petshots.utils.Typefaces;
import dinchi.org.petshots.utils.VaccinationDetailsLayoutUpdater;
import dinchi.org.petshots.utils.VaccineDetails;

public class VaccinationDetailsActivity extends ListActivity {

	static final String LOG_CLASS = "[VaccDetActivity]";
...
//                        .toString());
    ...
    private void showAlertDialog(String title, String message){
        ...
        final Dialog dialog = new Dialog(VaccinationDetailsActivity.this,R.style.CustomDialog);
    ...
    private void filldata(){
    	...
    	if(!vaccineList.isEmpty()){
    	    ...
    	    vaccineHeader.setTextColor(getResources().getColor(R.color.white));
...
//    	    dateHeader.setBackgroundResource(R.drawable.cell_shape);
    	    ...
    	    duedateHeader.setTextColor(getResources().getColor(R.color.white));
//    	    duedateHeader.setBackgroundResource(R.drawable.cell_shape);
    	    ...
    	    docHeader.setTextColor(getResources().getColor(R.color.white));
