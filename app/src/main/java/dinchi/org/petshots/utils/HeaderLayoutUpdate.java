...
import static dinchi.org.petshots.utils.Utils.getResourceName;
...
//	}
	...
	private void updateTitleBar(String title,int titleImage) {
		...
		mPrefs.EditPrefs(Constants.UI_Header+ getResourceName(activity, R.id.title_layout)+"_Margin_t",""+layoutParams.topMargin);//(calculatedTopMargin-3));
		...
		mPrefs.EditPrefs(Constants.UI_Header+ getResourceName(activity, R.id.title_img)+"_height",""+calculatedtitleHeigth);
