...
public class VaccineDetails {
	...
	dinchi.org.petshots.utils.PetDetail m_pet;
	dinchi.org.petshots.utils.DoctorDetails m_doc;
	 ...
	 * 
	 * */
	public VaccineDetails(long vacid,String vaccinename, dinchi.org.petshots.utils.PetDetail pet,DoctorDetails doc, String vdate,String ndate,String remarks){
		this.m_vacid = vacid;
	...
	public dinchi.org.petshots.utils.PetDetail getM_pet() {
		return m_pet;
	}


	public void setM_pet(dinchi.org.petshots.utils.PetDetail m_pet) {
		this.m_pet = m_pet;
	}


	public dinchi.org.petshots.utils.DoctorDetails getM_doc() {
		return m_doc;
	}


	public void setM_doc(dinchi.org.petshots.utils.DoctorDetails m_doc) {
		this.m_doc = m_doc;
	}
