...
//	ImageView petImageView;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    if(convertView==null){
	      ...
	      holder.tvPetName = (TextView)vi.findViewById(dinchi.org.petshots.R.id.tvpetName);
	      Log.i(KEY_TAG, "Before pet sex access, convertView is null");
	      holder.tvPetSex = (TextView)vi.findViewById(dinchi.org.petshots.R.id.tvpetsex);
	      Log.i(KEY_TAG, "Before pet age access, convertView is null");
	      holder.tvPetAge = (TextView)vi.findViewById(dinchi.org.petshots.R.id.tvpetage);
